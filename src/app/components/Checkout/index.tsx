      ...
      {items.length > 0 ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            ...
            {/* Table Product */}
            <div className="bg-white rounded-t-[10px] shadow-1">
            ...
            <div className="bg-white shadow-1 rounded-b-[10px] border-t">
              <div className="border-b border-gray-3 py-5 px-4 sm:px-8.5 flex justify-end">
